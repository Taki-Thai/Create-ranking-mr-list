...
def assign_pattern(s_rank_df, df_active_dr_at_mr_hp, df_case2):
    """Step 45: Pattern 1 = Case1 only, Pattern 2 = Case2 only, Pattern 3 = both, Pattern 0 = neither."""
...
def assign_suggested_hospital_name(s_rank_df, df_case2, max_hospitals=3):
    ...
    s_rank_df.loc[~s_rank_df["Pattern"].isin(["Pattern 2", "Pattern 3"]), "suggest_hospital_name"] = ""
